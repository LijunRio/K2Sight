...
class Florence2Processor(ProcessorMixin):
    ...
    def __init__(
        ...
        self.tasks_answer_post_processing_type = { # 定义
            '<OCR>': 'pure_text',
            '<OCR_WITH_REGION>': 'ocr',
            '<CAPTION>': 'pure_text',
            ...
            '<OD1>': 'description_with_bboxes',  # add
            '<OD2>': 'description_with_bboxes', # add
        ...
        self.task_prompts_without_inputs = {
            ...
            '<OD1>':'Identify all abnormal regions.',
            '<OD2>':'Detect all abnormal findings and show their locations.',
    ...
    def post_process_generation(self, text, task, image_size):
        ...
        task_answer_post_processing_type = self.tasks_answer_post_processing_type.get(task, 'pure_text') # task不在字典中则返回'pure_text'
